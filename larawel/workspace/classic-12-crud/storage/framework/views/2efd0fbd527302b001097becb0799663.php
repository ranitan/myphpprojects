            ...
            <div class="card-classic trashed-product">
                            ...
                            <div class="product-details">
                                ...
                                <?php if($product->deleted_at): ?>
                                    <div class="detail-item deleted-info">
                                        ...
                                        <div class="detail-value">
                                            <?php echo e($product->deleted_at->format('M d, Y \a\t g:i A')); ?>
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(route('product.trashed')); ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="btn-group">
                                    <form action="<?php echo e(route('product.restore', $product->id)); ?>" method="POST"
                                        ...
                                        class="btn btn-classic-warning btn-sm restore-btn" 
                                            ...
                                            <i class="fas fa-edit"></i> Restore Product
                                        </button>
                                    </form>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\G2TECH\OneDrive\Desktop\files\learning\myphpprojects\larawel\workspace\classic-12-crud\resources\views/product/show-trashed.blade.php ENDPATH**/ ?>