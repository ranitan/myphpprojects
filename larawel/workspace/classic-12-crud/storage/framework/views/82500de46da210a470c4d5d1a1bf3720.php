        ...
        <div class="col-lg-10">
            <div class="card-classic">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('product.store')); ?>" method="post" enctype="multipart/form-data" class="form-classic">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.layout", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\G2TECH\OneDrive\Desktop\files\learning\myphpprojects\larawel\workspace\classic-12-crud\resources\views/product/create.blade.php ENDPATH**/ ?>