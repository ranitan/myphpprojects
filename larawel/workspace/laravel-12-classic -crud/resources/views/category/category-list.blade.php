...
<div class="container-fluid p-4">
    ...
    <div class="row mb-4">
        <div class="col-lg-6">
            <form class="d-flex form-classic" role="search" action="{{ route('category.index')}}" method="GET">
                @csrf
        ...
        <div class="col-lg-6">
            <div class="d-flex justify-content-end gap-2">
                <a href="{{route('trashed.categories')}}" class="btn btn-classic-warning">
                    <i class="fas fa-trash-alt me-2"></i>View Trashed
                </a>
                <a href="{{route('category.create')}}" class="btn btn-classic-success">
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-secondary">
                                        <i class="fas fa-pause-circle me-1"></i>{{$category->status}}
                                    </span>
                                @endif
                            </td>
                            <td>
    ...
    <div class="card-classic">
        <div class="card-body text-center py-5">
            <div class="empty-state">
                ...
                <a href="{{route('category.create')}}" class="btn btn-classic-primary btn-lg">
