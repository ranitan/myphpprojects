    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            <span class="badge bg-warning fs-6 me-3">
                ...
                {{ $categories->total() ?? count($categories) }} Trashed Items
            </span>
        </div>
    </div>
</div>
...
<div class="container-fluid p-4">
    ...
    <div class="row mb-4">
        <div class="col-lg-6">
            <form class="d-flex form-classic" role="search" action="{{ route('trashed.categories')}}" method="GET">
                @csrf
        ...
        <div class="col-lg-6">
            <div class="d-flex justify-content-end gap-2">
                <a href="{{route('category.index')}}" class="btn btn-classic-success">
            ...
            <div class="trashed-category-card card-classic h-100">
                ...
                <div class="category-body">
                    ...
                    <div class="category-meta">
                        ...
                        <br>
                        <small class="text-muted">
                            <i class="fas fa-clock me-1"></i>Deleted: {{ $category->deleted_at ? $category->deleted_at->diffForHumans() : 'Unknown' }}
                        </small>
                    </div>
                ...
                <div class="category-actions">
                    <div class="action-buttons d-flex justify-content-center gap-1">
                        <a href="{{route('show.trashed.categories',$category->id)}}" 
                        ...
                        <tr class="trashed-category-row">
                            ...
                            <td>
                                <span class="badge bg-warning">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{$category->status}}
                                </span>
                            </td>
                            <td>
                                <small class="text-muted">
                                    <i class="fas fa-calendar me-1"></i>
                                    {{ $category->deleted_at ? $category->deleted_at->format('M d, Y') : 'Unknown' }}
                                    <br>
                                    <i class="fas fa-clock me-1"></i>
                                    {{ $category->deleted_at ? $category->deleted_at->diffForHumans() : 'Unknown' }}
                                </small>
                            </td>
                            <td>
                                <div class="action-buttons d-flex justify-content-center gap-1">
    ...
    <div class="card-classic">
        <div class="card-body text-center py-5">
            <div class="empty-state">
                ...
                <a href="{{route('category.index')}}" class="btn btn-classic-primary btn-lg">
                    <i class="fas fa-arrow-left me-2"></i>Back to Categories
                </a>
            </div>
        </div>
    ...
    <!-- Pagination -->
    @if(method_exists($categories, 'links') && count($categories) > 0)
