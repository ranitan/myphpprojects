            ...
            <div class="card-classic">
                <div class="card-header">
                    <h3 class="mb-0" style="font-family: 'Playfair Display', serif; color: var(--classic-primary);">
                        <i class="fas fa-info-circle me-2"></i>{{ $category->name }}
                    </h3>
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ route('trashed.categories') }}"
                           class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left me-2"></i>Back
                        </a>
                        <div class="btn-group">
                            @if(Route::currentRouteName() !== 'trashed.categories.show')
                                <a href="{{ route('category.edit', $category->id) }}" class="btn btn-classic-warning">
