                ...
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col">
                                <a href="{{route('product.trashed')}}" class="float-end btn btn-warning" style="margin-right: -57px;">Show Trashed</a>

                                </div>
                                <div class="col">
                                <a href="{{route('product.create')}}" class="float-end btn btn-success">Add New</a>
